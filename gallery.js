let photoCollection = [
  ...
  [
    "./assets/lobby/lb1.jpg",
    "./assets/lobby/lb2.jpg",
    "./assets/lobby/lb3.jpg",
    "./assets/lobby/lb4.jpg",
    "./assets/lobby/lb5.jpg",
    "./assets/lobby/lb6.jpg",
    "./assets/lobby/lb7.jpg",
    "./assets/lobby/lb8.jpg",
    "./assets/lobby/lb9.jpg",
    "./assets/lobby/lb10.jpg",
    "./assets/lobby/lb11.jpg",
    "./assets/lobby/lb12.jpg",
    "./assets/lobby/lb13.jpg",
    "./assets/lobby/lb14.jpg",
    "./assets/lobby/lb15.jpg",
    "./assets/lobby/lb16.jpg",
    "./assets/lobby/lb17.jpg",
    "./assets/lobby/lb18.jpg",
    "./assets/lobby/lb19.jpg",
    "./assets/lobby/lb20.jpg",
    "./assets/lobby/lb21.jpg",
  ],
];
let tipiCollection = [];
...
function changePics(index) {
  ...
  photoCollection[index].forEach((photo, idx) => {
    ...
    picBtn.addEventListener("click", () => {
      ...
      // nowShowing.setAttribute("loading", "lazy");
      nowShowing2.src = photo;
      // nowShowing2.setAttribute("loading", "lazy");
